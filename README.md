...
**在首次部署前，請先閱讀：**
- 🛡️ **[部署最佳實踐](./deployment/DEPLOYMENT_BEST_PRACTICES.md)** - 防止部署失敗的完整指南
- ✅ 運行部署前檢查：
  ```bash
...
**詳細文檔**:
- 🛡️ **[部署最佳實踐](./deployment/DEPLOYMENT_BEST_PRACTICES.md)** - 防止部署失敗指南 ⭐ **推薦優先閱讀**
- 📖 [完整部署指南](./deployment/README.md) - 詳細的伺服器設置和部署流程
- 🔐 [GitHub Secrets 配置](./deployment/SECRETS.md) - 完整的 Secrets 設置教程
- 📋 [快速參考卡](./deployment/QUICKREF.md) - 常用命令速查

**部署腳本**:
- `deployment/pre-deployment-check.sh` - 部署前檢查腳本 ⭐ **新增**
