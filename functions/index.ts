...
import * as supervisor from "./agents/supervisor";
...
app.post("/api/execute-sacred-command", async (req: express.Request, res: express.Response) => {
...
app.post("/api/add-knowledge", async (req: express.Request, res: express.Response) => {
