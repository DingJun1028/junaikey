...
export type SustainablePartnerInput = z.infer<typeof SustainablePartnerInputSchema>;

export async function sustainablePartnerFlow(input: SustainablePartnerInput): Promise<string> {
