...
export interface TradeSettings {
    ...
    transplantPythagorean: boolean,
    transplantPlatonic: boolean,
    transplantAristotelian: boolean,
    transplantHellenistic: boolean,
    transplantNeoplatonic: boolean,
    transplantAlexandrian: boolean,
    transplantByzantine: boolean,
    transplantScholastic: boolean,
    transplantThomistic: boolean,
    transplantFranciscan: boolean,
    transplantAugustinian: boolean,
    transplantMystical: boolean,
    transplantEsoteric: boolean,
    transplantHermetic: boolean,
    transplantGnostic: boolean,
    transplantManichaean: boolean,
    transplantMithraic: boolean,
    transplantDruidic: boolean,
    transplantCeltic: boolean,
    transplantGermanic: boolean,
    transplantNorse: boolean,
    transplantSlavic: boolean,
    transplantBaltic: boolean,
    transplantFinnic: boolean,
    transplantUralic: boolean,
    transplantTurkic: boolean,
    transplantMongolic: boolean,
    transplantTungusic: boolean,
    transplantKoreanic: boolean,
    transplantJaponic: boolean,
    transplantAinu: boolean,
    transplantTai: boolean,
    transplantAustroasiatic: boolean,
    transplantAustronesian: boolean,
    transplantMalayoPolynesian: boolean,
    transplantMelanesian: boolean,
    transplantMicronesian: boolean,
    transplantPolynesian: boolean,
    transplantPapuan: boolean,
    transplantAustralian: boolean,
    transplantTorresStraitIslander: boolean,
    transplantMaori: boolean,
    transplantHawaiian: boolean,
    transplantTahitian: boolean,
    transplantSamoan: boolean,
    transplantTongan: boolean,
    transplantFijian: boolean,
    transplantNiuean: boolean,
    transplantTokelauan: boolean,
    transplantTuvaluan: boolean,
    transplantKiribati: boolean,
    transplantMarshallese: boolean,
    transplantChamorro: boolean,
    transplantPalauan: boolean,
    transplantFijian2: boolean,
    transplantSolomonIslands: boolean,
    transplantVanuatu: boolean,
    transplantNewCaledonia: boolean,
    transplantPapuaNewGuinea: boolean,
    transplantWestPapua: boolean,
    transplantTimorLeste: boolean,
    transplantIndonesia: boolean,
    transplantMalaysia: boolean,
    transplantSingapore: boolean,
    transplantBrunei: boolean,
    transplantThailand: boolean,
    transplantLaos: boolean,
    transplantCambodia: boolean,
    transplantVietnam: boolean,
    transplantChina: boolean,
    transplantTaiwan: boolean,
    transplantHongKong: boolean,
    transplantMacao: boolean,
    transplantJapan: boolean,
    transplantKorea: boolean,
    transplantMongolia: boolean,
    transplantRussia: boolean,
    transplantKazakhstan: boolean,
    transplantUzbekistan: boolean,
    transplantTurkmenistan: boolean,
    transplantTajikistan: boolean,
    transplantKyrgyzstan: boolean,
    transplantGeorgia: boolean,
    transplantArmenia: boolean,
    transplantAzerbaijan: boolean,
}
...
// Re-export types for better type safety
export type { ColorIdentity, ManaCurve, Equipment, Enchantment, Effect, Condition, Buff, Debuff, Achievement, Milestone };
export type { PlayerStatistics, ConnectionInfo, PlayerSettings, NotificationSettings, GraphicsSettings, AudioSettings };
export type { EqualizerSettings, MicrophoneSettings, ControlSettings, KeyboardSettings, MacroSettings, MouseSettings };
export type { GamepadSettings, HotkeySettings, SensitivitySettings, GameplaySettings, AutomationSettings, CustomizationSettings };
export type { UISettings, PositionSettings, VisibilitySettings, AnimationSettings, EffectSettings, SocialSettings };
export type { ChatSettings, FriendSettings, GuildSettings, PartySettings, TradeSettings, AuctionSettings };

// Import types needed from other modules (if they exist)
// import type { Card } from './card';
// import type { Color, Element, Rarity } from './element';
// import type { Review, GameHistory, Permission, Restriction } from './common';
